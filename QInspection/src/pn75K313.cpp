    ...
    _rearDiffLockToggleState{false}
{
    _lightingItemVector.push_back(new Led1((std::vector<unsigned char> {0x40, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00}),
                                           ...
                                           (std::vector<unsigned char> {0x00, 0x00, 0xB1, 0x00, 0x00, 0x00, 0x00, 0x00}), 
                                           (std::vector<unsigned char> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})));

    _lightingItemVector.push_back(new Led2 ((std::vector<unsigned char> {0x40, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00}),
                                            (std::vector<unsigned char> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}),
                                            (std::vector<unsigned char> {0x00, 0x01, 0x91, 0x00, 0x00, 0x00, 0x00, 0x00}),
                                            (std::vector<unsigned char> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})));
    ...
    _lightingItemVector.push_back(new Led3((std::vector<unsigned char> {0x40, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00}),
                                           ...
                                           (std::vector<unsigned char> {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})));
    ...
    _lightingItemVector.push_back(new AllIndicators((std::vector<unsigned char> {0x40, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00}),
                                                    ...
                                                    (std::vector<unsigned char> {0x00, 0x01, 0xB1, 0x00, 0x00, 0x00, 0x00, 0x00}), 
                                                    (std::vector<unsigned char> {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})));
    ...
    _lightingItemVector.push_back(new DaytimeIllumination((std::vector<unsigned char> {0x40, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x00}),
                                                          (std::vector<unsigned char> {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}), 
                                                          (std::vector<unsigned char> {0x00, 0x01, 0xB1, 0x00, 0x00, 0x00, 0x00, 0x00}), 
                                                          (std::vector<unsigned char> {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})));
...
unsigned char pn75K313::allButtonsReleased() const
{
    return this->_allButtonsReleased;
}

unsigned char pn75K313::topLeftButtonPressed() const
{
    return this->_topLeftButtonPressed;
}

unsigned char pn75K313::topRightButtonPressed() const
{
    return this->_topRightButtonPressed;
}

unsigned char pn75K313::bottomLeftButtonPressed() const
{
    return this->_bottomLeftButtonPressed;
}

unsigned char pn75K313::bottomRightButtonPressed() const
{
    return this->_bottomRightButtonPressed;
}

void pn75K313::setInspectionMode(bool inspectionMode)
{
...
bool pn75K313::inspectionMode() const 
{
    return this->_inspectionMode;
}

bool pn75K313::canCommandStatusAt(LightingSpecifier ls) const
{
    return this->lightingItemAt(ls)->canCommandStatus(); 
}

void pn75K313::changeLightingItemStatus(LightingSpecifier ls, bool onOrOff)
{
...
void pn75K313::buttonPressEvent(ButtonSpecifier bs)
{
     if (!this->_inspectionMode) {
...
LightingItem *pn75K313::lightingItemAt(LightingSpecifier ls) const
{
...
void pn75K313::sendCanCommands(MCP_CAN *canController)
{
...
void pn75K313::sendLightingItemMessages(LightingItem *li, MCP_CAN *canController) const
{
...
void pn75K313::turnAllLightingOff()
{
    for (std::vector<LightingItem *>::const_iterator iter = _lightingItemVector.begin(); iter != _lightingItemVector.end(); iter++) {
...
void pn75K313::turnAllLightingExceptIlluminationOff()
{
    for (std::vector<LightingItem *>::const_iterator iter = _lightingItemVector.begin(); iter != _lightingItemVector.end(); iter++) {
...
bool pn75K313::rearDiffLockToggleState() const
{ 
    return this->_rearDiffLockToggleState;
}

std::string pn75K313::partNumber() const
{
