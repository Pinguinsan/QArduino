...
unsigned char pn75K314::allButtonsReleased() const
{
    return this->_allButtonsReleased;
}

unsigned char pn75K314::topLeftButtonPressed() const
{
    return this->_topLeftButtonPressed;
}

unsigned char pn75K314::topRightButtonPressed() const
{
    return this->_topRightButtonPressed;
}

unsigned char pn75K314::bottomLeftButtonPressed() const
{
    return this->_bottomLeftButtonPressed;
}

unsigned char pn75K314::bottomRightButtonPressed() const
{
    return this->_bottomRightButtonPressed;
}

void pn75K314::setInspectionMode(bool inspectionMode)
{
...
bool pn75K314::inspectionMode() const 
{
    return this->_inspectionMode;
}

bool pn75K314::canCommandStatusAt(LightingSpecifier ls) const
{
    return this->lightingItemAt(ls)->canCommandStatus(); 
}

void pn75K314::changeLightingItemStatus(LightingSpecifier ls, bool onOrOff)
{
...
void pn75K314::buttonPressEvent(ButtonSpecifier bs)
{
    if (!this->_inspectionMode) {
...
LightingItem *pn75K314::lightingItemAt(LightingSpecifier ls) const
{
...
void pn75K314::sendCanCommands(MCP_CAN *canController)
{
...
void pn75K314::sendLightingItemMessages(LightingItem *li, MCP_CAN *canController) const
{
...
void pn75K314::turnAllLightingOff()
{
    for (std::vector<LightingItem *>::const_iterator iter = _lightingItemVector.begin(); iter != _lightingItemVector.end(); iter++) {
...
void pn75K314::turnAllLightingExceptIlluminationOff()
{
    for (std::vector<LightingItem *>::const_iterator iter = _lightingItemVector.begin(); iter != _lightingItemVector.end(); iter++) {
...
bool pn75K314::rearDiffLockToggleState() const
{
    return this->_rearDiffLockToggleState;
}

std::string pn75K314::partNumber() const
{
